...
## Semana 9 | 26 de Abril - 02 de Maio
...
- Resolução de problemas individuais:
  ...
  - [Connecting Graph](https://codeforces.com/gym/100814/problem/C) - [implementação](../master/treinos_solo/2015%20ECPC%20/c.cpp) (1 Hora);
...
## Semana 10 | 03-09 de Maio

- Estudo e [implementação](../master/algos_notebook/graphs/centroidDecomp.cpp) da tecnica de [centroid decomposition](https://www.quora.com/q/threadsiiithyderabad/Centroid-Decomposition-of-a-Tree) que permite consultas e alterações em arvores em tempo logaritmico. (3 Horas)

- Participação virtual e individual no [Educational Codeforces Round 86](https://codeforces.com/contest/1342). (2 Horas)
  - Problemas resolvidos: [A](../master/Codforces/roadToZero.cpp), [B](../master/Codforces/binaryPeriod.cpp) e [C](../master/Codforces/yetAnotherCountingProblem.cpp).

- Participação virtual e em equipe no [2009-2010 ACM-ICPC Nordic Collegiate Programming Contest (NCPC 2009)](https://codeforces.com/gym/101557). (5 Horas)
  - Problemas resolvidos: A, B, D, E e I;
  - [Implementações](../master/treinos_equipe/2009%20NCPC)

- Resolução de problemas individuais:
  - [Xenia and Tree](https://codeforces.com/contest/342/problem/E) - [implementação](../master/Codforces/xeniaAndTree.cpp) (50 minutos);
  - [Query on a tree V](https://www.spoj.com/problems/QTREE5/) - [implementação](../master/Spoj/qtree5.cpp) (30 minutos);
  - [Ciel the Commander](https://codeforces.com/contest/321/problem/C) - [implementação](../master/Codforces/cielTheCommander.cpp) (20 minutos);
  - [Prime Distance On Tree](https://www.codechef.com/problems/PRIMEDST) - [implementação](../master/others/primedst.cpp) (1:20 Horas);
  - [Multiple Testcases](https://codeforces.com/contest/1342/problem/D) - [implementação](../master/Codforces/multipleTestcases.cpp) (20 minutos);
  - [Flight Planningc](https://codeforces.com/gym/101557/problem/G) - [implementação](../master/treinos_solo/2009%20NCPC%20upsolving/g.cpp) (40 minutos);
  - [Allergy Test](https://codeforces.com/gym/101557/problem/C) - [implementação](../master/treinos_solo/2009%20NCPC%20upsolving/c.cpp) (30 minutos);
...
## Semana 11 | 10-16 de Maio

- Participação virtual e individual no [Codeforces Round #638](https://codeforces.com/contest/1348). (2:30 Horas)
  - Problemas resolvidos: [A](../master/Codforces/phoenixAndBalance.cpp), [B](../master/Codforces/phoenixAndBeauty.cpp) e [C](../master/Codforces/phoenixAndDistribution.cpp).
...
## Semana 12 | 17-23 de Maio

- Participação virtual e individual no [Codeforces Round #639](https://codeforces.com/contest/1345). (2:10 Horas)
  - Problemas resolvidos: [A](../master/Codforces/puzzlePieces.cpp), [B](../master/Codforces/cardConstructions.cpp) e [C](../master/Codforces/hilbertsHotel.cpp).

- Participação virtual e individual no [Codeforces Round #641](https://codeforces.com/contest/1350). (2:30 Horas)
  - Problemas resolvidos: [A](../master/Codforces/oracAndFactors.cpp) e [B](../master/Codforces/oracAndModels.cpp).

- Participação virtual e individual no [Codeforces Round #643](https://codeforces.com/contest/1355). (2 Horas)
  - Problemas resolvidos: [A](../master/Codforces/sequenceWithDigits.cpp) e [B](../master/Codforces/youngExplorers.cpp).

- Participação virtual e em equipe no [2018-2019 ACM-ICPC Pacific Northwest Regional Contest](https://codeforces.com/gym/101982). (5 Horas)
  - Problemas resolvidos: A, B, C, D, E, F, G, H, J, K e L.
  - [Implementações](../master/treinos_equipe/2019%20PNRC)

- Resolução de problemas individuais:
  - [Monopole Magnets](https://codeforces.com/contest/1345/problem/D) - [implementação](../master/Codforces/monopoleMagnets.cpp) (10 minutos);  
  - [Orac and LCM](https://codeforces.com/contest/1350/problem/C) - [implementação](../master/Codforces/oracAndLCM.cpp) (20 minutos);
  - [Count Triangles](https://codeforces.com/contest/1355/problem/C) - [implementação](../master/Codforces/countTriangles.cpp) (10 minutos);
  - [Game With Array](https://codeforces.com/contest/1355/problem/D) - [implementação](../master/Codforces/gameWithArray.cpp) (10 minutos);
...
## Semana 13 | 24-30 de Maio

- Participação virtual e individual no [Codeforces Round #642](https://codeforces.com/contest/1353). (2 Horas)
  - Problemas resolvidos: [A](../master/Codforces/mostUnstableArray.cpp), [B](../master/Codforces/twoArraysAndSwaps.cpp), [C](../master/Codforces/boardMoves.cpp) e [D](../master/Codforces/constructingTheArray.cpp).

- Participação virtual e individual no [Educational Codeforces Round 87](https://codeforces.com/contest/1354). (2 Horas)
  - Problemas resolvidos: [A](../master/Codforces/alarmClock.cpp), [B](../master/Codforces/ternarySearch.cpp) e [C](../master/Codforces/simlpePolygonEmbenign.cpp).

- Paticipação na [Seletiva Individual 2020: Segunda Prova](https://vjudge.net/contest/374753). (3:20 Horas)
  - Problemas resolvidos: A, B e C.
  - [Implementações](../master/treinos_solo/2020%20seletiva2)

- Participação virtual e individual no [Codeforces Round #645](https://codeforces.com/contest/1358). (1 Hora)
  - Problemas resolvidos: [A](../master/Codforces/parkLighting.cpp) e [B](../master/Codforces/mariaBreaksTheSelfIsolation.cpp).
  
- Resolução de problemas individuais:
  - [Not So Simple Polygon Embedding](https://codeforces.com/contest/1354/problem/C2) - [implementação](../master/Codforces/notSoSimplePolygonEmbedding.cpp) (10 minutos);
  - [Multiset](https://codeforces.com/contest/1354/problem/D) - [implementação](../master/Codforces/multiset.cpp) (30 minutos);
  - [K-periodic Garland](https://codeforces.com/contest/1353/problem/E) - [implementação](../master/Codforces/kPeriodicGarland.cpp) (30 minutos);
  - [Celex Update](https://codeforces.com/contest/1358/problem/C) - [implementação](../master/Codforces/celexUpdate.cpp) (10 minutos);
  - [Projesk](https://vjudge.net/contest/376169#problem/E) - [implementação](../master/others/projesk.cpp) (30 minutos);

Tempo gasto na semana: 9:00 horas.  
Tempo total acumulado ao fim da semana: 140:20 horas.

## Semana 14 | 31 de Maio a 06 de Junho

- Resolução de problemas individuais:
  - [Simplifying the Farm](https://vjudge.net/contest/376169#problem/D) - [implementação](../master/others/simplifyingTheFarm.cpp) (1 Hora);
  - [Fairy](https://codeforces.com/contest/19/problem/E) - [implementação](../master/Codforces/fairy.cpp) (1 Hora);

Tempo gasto na semana: 2 horas.  
Tempo total acumulado ao fim da semana: 142:20 horas.

## Semana 15 | 07-13 de Junho
...
- Participação virtual e individual no [Codeforces Round 646 (Div. 2)](https://codeforces.com/contest/1363). (2 Horas)
  - Problemas resolvidos: [A](../master/Codforces/oddSelection.cpp), [B](../master/Codforces/subsequenceHate.cpp) e [C](../master/Codforces/gameOnLeaves.cpp).

- Participação virtual e em equipe no [2018 Arab Collegiate Programming Contest (ACPC 2018)](https://codeforces.com/gym/101991). (5 Horas)
  - Problemas resolvidos: B, C, I e L.
  - [Implementações](../master/treinos_equipe/2018%20ACPC)
  
- Resolução de problemas individuais:
  - [Tree Shuffling](https://codeforces.com/contest/1363/problem/E) - [implementação](../master/Codforces/treeShuffling.cpp) (20 minutos);
