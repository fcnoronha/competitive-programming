...
- Estudo e [implementação](../blob/master/algos_notebook/geometry/closestPair.cpp) do algoritmo de Shamos e Hoey para achar o par de pontos mais proximos. (2 horas)
...
- Resolução de problemas individuais:
  ...
  - [Closest Point Pair](https://www.spoj.com/problems/CLOPPAIR/) - [implementação](../blob/master/) (10 minutos);
  - [Ehab the Xorcist](https://codeforces.com/contest/1325/problem/D) - [implementação](../blob/master/Codforces/ehabTheXorcist.cpp) (30 minutos);
  - [Minimum Sum](https://codeforces.com/contest/120/problem/J) - [implementação](../blob/master/Codforces/minimumSum.cpp) (30 minutos);
  - [Closest Triplet](https://www.spoj.com/problems/CLOSEST/) - [implementação](../blob/master/Spoj/CLOSEST.cpp) (30 minutos);
  - [Magical Length](https://www.codechef.com/problems/ACM14KP1) - [implementação](../blob/master/others/magicalLength.cpp) (10 minutos);
  - [Flowers](https://codeforces.com/problemset/problem/474/D) - [implementação](../blob/master/Codforces/flowers.cpp) (20 minutos);
  - [Prizes, Prizes, more Prizes](https://codeforces.com/contest/208/problem/D) - [implementação](../blob/master/Codforces/prizesPrizesMorePrizes.cpp) (20 minutos);
  - [Xenia and Bit Operations](https://codeforces.com/contest/339/problem/D) - [implementação](../blob/master/Codforces/XeniaAndBitOperations.cpp) (30 minutos);
