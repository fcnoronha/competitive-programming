...
- Estudo e [implementação](https://github.com/mrfelipenoronha/competitive-programming/blob/4ab7a9646c5e9d1d1433dd8eb43c7185990e66f4/algos_notebook/geometry/closestPair.cpp) do algoritmo de Shamos e Hoey para achar o par de pontos mais proximos. (2 horas)

- Resolução de problemas individuais:

  - [The Closest Pair Problem](https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1186) - [implementação](https://github.com/mrfelipenoronha/competitive-programming/blob/4ab7a9646c5e9d1d1433dd8eb43c7185990e66f4/online-judge/theClosestPairProblem.cpp) (10 minutos);
  - [Closest Point Pair](https://www.spoj.com/problems/CLOPPAIR/) - [implementação](https://github.com/mrfelipenoronha/competitive-programming/blob/4ab7a9646c5e9d1d1433dd8eb43c7185990e66f4/Spoj/CLOPPAIR.cpp) (10 minutos);
  - [Ehab the Xorcist](https://codeforces.com/contest/1325/problem/D) - [implementação](...) (30 minutos);
  - [Minimum Sum](https://codeforces.com/contest/120/problem/J) - [implementação](...) (30 minutos);
  - [Closest Triplet](https://www.spoj.com/problems/CLOSEST/) - [implementação](...) (30 minutos);
  - [Magical Length](https://www.codechef.com/problems/ACM14KP1) - [implementação](...) (10 minutos);
  - [Flowers](https://codeforces.com/problemset/problem/474/D) - [implementação](...) (20 minutos);
  - [Prizes, Prizes, more Prizes](https://codeforces.com/contest/208/problem/D) - [implementação](...) (20 minutos);
  - [Xenia and Bit Operations](https://codeforces.com/contest/339/problem/D) - [implementação](...) (30 minutos);
